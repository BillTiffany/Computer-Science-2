...
// // ANSWER:
// it is not possible to improve this function's space complexity'
...
// // ANSWER: 
// Its dependent upon the input which is the string and the string is the same for both.
...
class newCache {
  ...
  addNewPerson(name,age,state) {
    let personage = `${name}${age}${state}`;
    if (this.cache.hasOwnProperty(personage)) {
      return this.cache[personage]
    }
    let answer = name + ' ' + age + ' ' + state
    this.cache[personage] = answer;
    return answer;
  }
...
// CODE HERE 
function noCacheNewPerson(name,age,state) {
  let personage = `${name}${age}${state}`;
  let answer = name + ' ' + age + ' ' + state
  return answer;
}
...
// ANSWER: Cached will be faster

// Now fill this out and run your file

const makePerson = new newCache()

console.time("not memoized function time");
console.log(noCacheNewPerson("John",24,"Utah"))
console.log(noCacheNewPerson("John",24,"Utah"))
console.log(noCacheNewPerson("John",24,"Utah"))
console.log(noCacheNewPerson("John",24,"Utah"))
...
console.log(makePerson.addNewPerson("John",24,"Utah"))
console.log(makePerson.addNewPerson("John",24,"Utah"))
console.log(makePerson.addNewPerson("John",24,"Utah"))
console.log(makePerson.addNewPerson("John",24,"Utah"))
